"""
Produce flop_trade_model_v32.docx from v8.docx.
...
def write_title_and_abstract(doc, body, all_el, hmap, demand_data=None):
    ...
    r_ver = ver_p.add_run(f'v32  \u2014  {datetime.now().strftime("%B %d, %Y  %H:%M")}')
...
def main():
    ...
    out = DOCS / "flop_trade_model_v32.docx"
    ...
    try:
        ...
        result = subprocess.run(
            ['git', 'commit', '-m', f'Auto-save v32: {_ts}'],
