"""
Produce flop_trade_model_v27.docx from v8.docx.
...
def write_title_and_abstract(doc, body, all_el, hmap):
    ...
    r_ver = ver_p.add_run(f'v27  \u2014  {datetime.now().strftime("%B %d, %Y  %H:%M")}')
...
def main():
    ...
    out = DOCS / "flop_trade_model_v27.docx"
    ...
    try:
        ...
        result = subprocess.run(
            ['git', 'commit', '-m', f'Auto-save v27: {_ts}'],
